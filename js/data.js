                ...
                groups: [
                    {
                        id: 'leeds-furs',
                        name: 'LeedsFurs',
                        description: 'Leeds furry community organizing local meets and socials across the region. Main meet: 3rd Saturday monthly; Coffee meet: 1st Tuesday monthly.',
                        telegramLink: '#',
                ...
                groups: [
                    {
                        id: 'doncaster-furs',
                        name: 'Doncaster Furs',
                        description: 'Local Doncaster furry community for meetups and regional events.',
                        telegramLink: '#',
                ...
                groups: [
                    {
                        id: 'sussex-furs',
                        name: 'SussexFurs',
                        description: 'Sussex furry community organising occasional larger meets and events (parties, summer meet-ups) across Brighton and the South Coast.',
                        telegramLink: '#',
